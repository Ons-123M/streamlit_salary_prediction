...
if nav == "Prediction":
    ...
    val = st.number_input("Enter you experience here",0.00,20.00,step=0.25)
...
if nav == "Contribute":
    ...
    if st.button("submit"):
        to_add1={"YearsExperience":ex,"Salary":sal}
        to_add = pd.DataFrame(to_add1,index=[-1])
